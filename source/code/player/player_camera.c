...
void camera_get_input(PLAYER *hero)
{
    if (!hero)
    {
        diag("\nERROR! No camera input from player, his structure doesn't exist!");
        return;
    }
...
void camera_bobbing(CCT *cct, PLAYER *hero)
{
    if (!hero)
    {
        diag("\nERROR! No camera bobbing effect for player, his structure doesn't exist!");
        return;
    }

    if (!cct)
    {
        diag("\nERROR! No camera bobbing effect for player, his cct doesn't exist!");
        return;
    }
...
void camera_bobbing_reset(CCT *cct, PLAYER *hero)
{
    if (!hero)
    {
        diag("\nERROR! No can't reset bobbing effect for player, his structure doesn't exist!");
        return;
    }

    if (!cct)
    {
        diag("\nERROR! No can't reset bobbing effect for player, his cct doesn't exist!");
        return;
    }
...
void set_camera_fog(CCT *cct, PLAYER *hero)
{
    if (!hero)
    {
        diag("\nERROR! No camera fog for player, his structure doesn't exist!");
        return;
    }

    if (!cct)
    {
        diag("\nERROR! No camera fog for player, his cct doesn't exist!");
        return;
    }
...
void camera_recoil(ENTITY *ent, PLAYER *hero)
{
    if (!ent)
    {
        diag("\nERROR! No camera recoil for player, he doesn't exist!");
        return;
    }

    if (!hero)
    {
        diag("\nERROR! No camera recoil for player, his structure doesn't exist!");
        return;
    }
...
void camera_explosion_shake(PLAYER *hero)
{
    if (!hero)
    {
        diag("\nERROR! No camera explosion shakes for player, his structure doesn't exist!");
        return;
    }
...
void camera_update(ENTITY *ent, CCT *cct, PLAYER *hero)
{
    if (!ent)
    {
        diag("\nERROR! No camera for player, he doesn't exist!");
        return;
    }

    if (!cct)
    {
        diag("\nERROR! No camera for player, his cct doesn't exist!");
        return;
    }

    if (!hero)
    {
        diag("\nERROR! No camera for player, his structure doesn't exist!");
        return;
    }
    // alive?
    if (ent->OBJ_HEALTH > 0)
